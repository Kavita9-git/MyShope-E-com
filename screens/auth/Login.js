...
import { login, clearMessage, updateSavedAddresses } from '../../redux/features/auth/userActions';
  ...
  const checkPendingAddresses = async () => {
    try {
      ...
      if (pendingAddressJson) {
        ...
        const savedAddressesJson = await AsyncStorage.getItem('@savedShippingAddresses');
        let savedAddresses = [];
        ...
        if (!addressExists) {
          ...
          await AsyncStorage.setItem('@savedShippingAddresses', JSON.stringify(updatedAddresses));
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.container}>
          <View style={styles.headerContainer}>
            ...
            <Icon name="login" size={80} color="#007AFF" style={styles.mainIcon} />

            <Text style={styles.headerText}>Welcome Back!</Text>
            <Text style={styles.subHeaderText}>Login to continue your shopping experience.</Text>
          </View>
