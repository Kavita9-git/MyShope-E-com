...
//useDispatch use to dispatch request to redux store
//useSelector use to fetch data from redux store and also to access global state

const Login = ({ navigation }) => {
  // const loginImage =
  //   "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPqzUfXQG6RjxJqSloKaSOamu1wxAT5QVR9A&s";
