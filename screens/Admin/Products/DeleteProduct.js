...
import { getAllProducts, deleteProduct } from '../../../redux/features/auth/productActions';
import Layout from '../../../components/Layout/Layout';
import Icon from 'react-native-vector-icons/MaterialCommunityIcons';
import { LinearGradient } from 'expo-linear-gradient';

const DeleteProduct = ({ route }) => {
  ...
  const handleDeleteProduct = () => {
    ...
    Alert.alert('Confirm Delete', 'Are you sure you want to delete this product permanently?', [
    ...
    <Layout showBackButton={true}>
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.headerContainer}>
          <LinearGradient colors={['#e53e3e', '#c53030', '#9b2c2c']} style={styles.headerGradient}>
        ...
        <View style={styles.cardContainer}>
          {loading && <ActivityIndicator size="large" color="#c53030" style={styles.loader} />}
          ...
          <View style={styles.warningBox}>
            ...
            <Text style={styles.warningText}>
              Warning: This action cannot be undone. The product will be permanently deleted.
            </Text>
          </View>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <LinearGradient colors={['#e53e3e', '#c53030', '#9b2c2c']} style={styles.btnGradient}>
