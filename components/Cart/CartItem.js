  ...
  return (
    <>
      <View style={styles.container}>
        <TouchableOpacity
          onPress={() => navigation.navigate('productDetails', { _id: item?.productId?._id })}
        ...
        <View style={styles.infoContainer}>
          ...
          <View style={styles.actionRow}>
            ...
            <TouchableOpacity onPress={handleRemove} disabled={isRemoving || loading}>
              <LinearGradient
              ...
              >
                <AntDesign name="delete" size={14} color="#fff" style={styles.removeIcon} />
